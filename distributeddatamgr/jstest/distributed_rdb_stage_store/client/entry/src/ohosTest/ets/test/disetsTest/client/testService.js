...
let abilityNameObj = "com.acts.distributedobjectdisets.ServiceAbility";
...
export default class TestService {
    ...
    toConnectAbility() {
        ...
        return new Promise(resolve=>{
            ...
            let context = AppStorage.get('context');
            ...
            try {
              ...
              console.error(logTag + ` ***** connectServiceExtensionAbility failed. err code is ${err.code}, message is ${err.message}`);
            }
        })
    }
