...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_0100
 * @tc.name   : SessionId doesn’t exist，Failed to send byte
 * @tc.desc   : Test Transceiver data reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_0100, TestSize.Level3)
{
    int ret;
    int sessionId = 0;
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_0200
 * @tc.name   : SessionId closed，Failed to send byte
 * @tc.desc   : Test Transceiver data reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_0200, TestSize.Level3)
{
    int ret;
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_0300
 * @tc.name   : send data during OpenSession
 * @tc.desc   : Test Transceiver data reliability
 * @tc.type   : FUNC
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_0300, TestSize.Level3)
{
    int ret;
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_0400
 * @tc.name   : SessionId doesn’t exist，Failed to send Message
 * @tc.desc   : Test Transceiver data reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_0400, TestSize.Level3)
{
    int ret;
    int sessionId = 0;
    string data = "invalid session id";
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_0500
 * @tc.name   : CreateSessionServer repeatedly
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_0500, TestSize.Level3)
{
    int ret;
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_0600
 * @tc.name   : CreateSessionServer input pkg name null
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_0600, TestSize.Level3)
{
    int ret;
    ...
    ret = RemoveSessionServer(DEF_PKG_NAME, SESSION_NAME_DATA);
    EXPECT_EQ(SOFTBUS_TRANS_CHECK_PID_ERROR, ret) << "RemoveSS fail[session listener only malloc]";
}

/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_0700
 * @tc.name   : CreateSessionServer input session name null
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_0700, TestSize.Level3)
{
    int ret;
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_0800
 * @tc.name   : CreateSessionServer input session listener null
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_0800, TestSize.Level3)
{
    int ret;
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_0900
 * @tc.name   : CreateSessionServer input session listener only malloc
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_0900, TestSize.Level3)
{
    int ret;
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_1000
 * @tc.name   : CreateSessionServer input session listener only malloc
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_1000, TestSize.Level3)
{
    int ret;
    ISessionListener* listener = (ISessionListener*)malloc(sizeof(ISessionListener));
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_1100
 * @tc.name   : RemoveSessionServer input pkg name null
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_1100, TestSize.Level3)
{
    int ret;
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_1200
 * @tc.name   : RemoveSessionServer input session name null
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_1200, TestSize.Level3)
{
    int ret;
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_1300
 * @tc.name   : RemoveSessionServer input all null
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_1300, TestSize.Level3)
{
    int ret;
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_1400
 * @tc.name   : OpenSession, SessionServer do not exist
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_1400, TestSize.Level3)
{
    int ret;
    int sessionId;
    ResetWaitFlag4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_1500
 * @tc.name   : OpenSession Open the same one repeatedly
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_1500, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_1600
 * @tc.name   : OpenSession input my name null
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_1600, TestSize.Level3)
{
    int ret;
    ret = CreateSessionServer(DEF_PKG_NAME, SESSION_NAME_DATA, GetSessionListenser4Data());
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_1700
 * @tc.name   : OpenSession input peer name null
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_1700, TestSize.Level3)
{
    int ret;
    ret = CreateSessionServer(DEF_PKG_NAME, SESSION_NAME_DATA, GetSessionListenser4Data());
    EXPECT_EQ(SOFTBUS_OK, ret) << "CreateSessionServer fail";
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_1800
 * @tc.name   : OpenSession input net id null
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_1800, TestSize.Level3)
{
    int ret;
    ret = CreateSessionServer(DEF_PKG_NAME, SESSION_NAME_DATA, GetSessionListenser4Data());
    EXPECT_EQ(SOFTBUS_OK, ret) << "CreateSessionServer fail";
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_1900
 * @tc.name   : OpenSession input net id invalid
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_1900, TestSize.Level3)
{
    int ret;
    ret = CreateSessionServer(DEF_PKG_NAME, SESSION_NAME_DATA, GetSessionListenser4Data());
    EXPECT_EQ(SOFTBUS_OK, ret) << "CreateSessionServer fail";
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_2000
 * @tc.name   : OpenSession input group id null
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_2000, TestSize.Level3)
{
    int ret;
    ret = CreateSessionServer(DEF_PKG_NAME, SESSION_NAME_DATA, GetSessionListenser4Data());
    EXPECT_EQ(SOFTBUS_OK, ret) << "CreateSessionServer fail";
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_2100
 * @tc.name   : OpenSession input arrt null
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_2100, TestSize.Level3)
{
    int ret;
    ret = CreateSessionServer(DEF_PKG_NAME, SESSION_NAME_DATA, GetSessionListenser4Data());
    EXPECT_EQ(SOFTBUS_OK, ret) << "CreateSessionServer fail";
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_2200
 * @tc.name   : OpenSession input arrt invalid
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_2200, TestSize.Level3)
{
    int ret;
    ret = CreateSessionServer(DEF_PKG_NAME, SESSION_NAME_DATA, GetSessionListenser4Data());
    EXPECT_EQ(SOFTBUS_OK, ret) << "CreateSessionServer fail";
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_2300
 * @tc.name   : CloseSession repeatedly
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_2300, TestSize.Level3)
{
    int ret;
    int sessionId;
    char* softbusPidStart;
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_2400
 * @tc.name   : CloseSession not exist sessionId
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_2400, TestSize.Level3)
{
    int ret;
    int timeout = 3;
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_2500
 * @tc.name   : GetMySessionName input invalid sid -1
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_2500, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_2600
 * @tc.name   : GetMySessionName input invalid sid max+1
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_2600, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_2700
 * @tc.name   : GetMySessionName input invalid sid not open
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_2700, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_2800
 * @tc.name   : GetMySessionName input MySessionName invalid sname null
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_2800, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_2900
 * @tc.name   : GetMySessionName input MySessionName invalid len[max+1]
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_2900, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_3000
 * @tc.name   : GetMySessionName input MySessionName len short than real
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_3000, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_3100
 * @tc.name   : GetPeersessionName input invalid sid -1
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_3100, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_3200
 * @tc.name   : GetPeersessionName input invalid sid max+1
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_3200, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_3300
 * @tc.name   : GetPeersessionName input invalid sid not open
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_3300, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_3400
 * @tc.name   : GetPeersessionName input SessionName invalid sname[null]
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_3400, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_3500
 * @tc.name   : GetPeersessionName input PeerSessionName invalid len[max+1]
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_3500, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_3600
 * @tc.name   : GetPeersessionName input PeerSessionName len short than real
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_3600, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_3700
 * @tc.name   : GetPeerDeviceId input DeviceId invalid sid -1
 * @tc.desc   : 【G-DISTRIBUTED-0205】禁止修改Openharmony分布式软总线设备间传输通道管理协议。
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_3700, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_3800
 * @tc.name   : GetPeerDeviceId input DeviceId invalid sid[max+1]
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_3800, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_3900
 * @tc.name   : GetPeerDeviceId input DeviceId invalid sid not open
 * @tc.desc   : 【G-DISTRIBUTED-0205】禁止修改Openharmony分布式软总线设备间传输通道管理协议。
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_3900, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_4000
 * @tc.name   : GetPeerDeviceId input DeviceId invalid sname[null]
 * @tc.desc   : 【G-DISTRIBUTED-0205】禁止修改Openharmony分布式软总线设备间传输通道管理协议。
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_4000, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_4100
 * @tc.name   : GetPeerDeviceId input DeviceId invalid len[max+1]
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_4100, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_4200
 * @tc.name   : GetPeerDeviceId input DeviceId len short than real
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_4200, TestSize.Level3)
{
    int ret;
    int sessionId;
    ret = CreateSsAndOpenSession4Data();
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_4300
 * @tc.name   : OpenSession, no Session Server exists on the peer
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_4300, TestSize.Level3)
{
    int ret;
    char* softbusPidStart;
    char* softbusPidEnd;
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_4400
 * @tc.name   : CreateSessionServer, input sessionName Max success
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_4400, TestSize.Level3)
{
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_4500
 * @tc.name   : CreateSessionServer, input sessionName contains special char
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_4500, TestSize.Level3)
{
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_4600
 * @tc.name   : CreateSessionServer, input pkgName Max success
 * @tc.desc   : Test session management reliability
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_4600, TestSize.Level3)
{
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_4700
 * @tc.name   : CreateSessionServer, input pkgNameMax and sessionNameMax
 * @tc.desc   : 【G-DISTRIBUTED-0205】禁止修改Openharmony分布式软总线设备间传输通道管理协议。
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_4700, TestSize.Level3)
{
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_4800
 * @tc.name   : CreateSessionServer, input pkgName Max+1 failed
 * @tc.desc   : 【G-DISTRIBUTED-0205】禁止修改Openharmony分布式软总线设备间传输通道管理协议。
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_4800, TestSize.Level3)
{
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_4900
 * @tc.name   : CreateSessionServer, input sessionName Max+1 failed
 * @tc.desc   : 【G-DISTRIBUTED-0205】禁止修改Openharmony分布式软总线设备间传输通道管理协议。
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_4900, TestSize.Level3)
{
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_5000
 * @tc.name   : CreateSessionServer, input pkgName contains special char
 * @tc.desc   : 【G-DISTRIBUTED-0205】禁止修改Openharmony分布式软总线设备间传输通道管理协议。
 * @tc.type   : RELI
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_5000, TestSize.Level3)
{
    int ret = CreateSessionServer(DEF_PKG_NAME, SESSIONNAME_MAX, GetSessionListenser4Ctl());
    EXPECT_EQ(SOFTBUS_OK, ret) << "CreateSS-ctrl fail";
    ret = RemoveSessionServer(DEF_PKG_NAME, SESSIONNAME_MAX);
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_5100
 ...
 * @tc.size   : MediumTest
 */
HWTEST_F(TransReliabilityTest, SUB_DSoftbus_Spec_DCTS_SessionServer_5100, TestSize.Level3)
{
...
/**
 * @tc.number : SUB_DSoftbus_Spec_DCTS_SessionServer_5200
