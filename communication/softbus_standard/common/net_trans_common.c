...
int Wait4Session(int timeout, WaitSessionType type)
{
    ...
    case SESSION_4DATA:
        ...
        {
            LOG("Wait4Session[data] fail[exp:%d, real:%d]", WAIT_SUCCESS_VALUE,
                g_waitFlag4Data);
            return SOFTBUS_ERR;
        }
        break;
...
static int OnReceiveFileProcess(int sessionId, const char *firstFile,
                                uint64_t bytesUpload, uint64_t bytesTotal)
{
    return 0;
}

static void OnReceiveFileFinished(int sessionId, const char *files,
                                  int fileCnt)
{
...
static int OnSendFileProcess(int sessionId, uint64_t bytesUpload,
                             uint64_t bytesTotal)
{
    return 0;
}
...
static void OnJoinNetCallBack(ConnectionAddr *addr, const char *networkId,
                              int32_t retCode)
{
...
static void CheckReceiveData(int sessionId, const void *data,
...
static void DataBytesReceived(int sessionId, const void *data,
                              unsigned int dataLen)
{
...
static void DataMessageReceived(int sessionId, const void *data,
                                unsigned int dataLen)
{
...
static void ControlBytesReceived(int sessionId, const void *data,
                                 unsigned int dataLen)
{
...
static void ControlMessageReceived(int sessionId, const void *data,
                                   unsigned int dataLen)
{
...
static void PassiveBytesReceived(int sessionId, const void *data,
                                 unsigned int dataLen)
{
...
static void PassiveMessageReceived(int sessionId, const void *data,
                                   unsigned int dataLen)
{
...
static void PerfBytesReceived(int sessionId, const void *data,
                              unsigned int dataLen)
{
...
static void PerfMessageReceived(int sessionId, const void *data,
                                unsigned int dataLen)
{
...
static void ProxyBytesReceived(int sessionId, const void *data,
                               unsigned int dataLen)
{
...
static void ProxyMessageReceived(int sessionId, const void *data,
                                 unsigned int dataLen)
{
...
void ResetWaitFlag(void) { g_waitFlag = WAIT_DEF_VALUE; }

void ResetWaitFlag4Data(void) { g_waitFlag4Data = WAIT_DEF_VALUE; }

void ResetWaitFlag4Ctl(void) { g_waitFlag4Ctl = WAIT_DEF_VALUE; }

void ResetWaitCount4Offline(void) { g_nodeOfflineCount = 0; }

void ResetWaitCount4Online(void) { g_nodeOnlineCount = 0; }
...
int SendCtrlMsgToRemote(CtrlCodeType code)
{
    ...
    case CTRL_CODE_CLOSE_WIFI_TEN_SEC:
        ret = SendMessage(g_currentSessionId4Ctl, CTRL_MSG_CLOSE_WIFI_TEN_SEC,
                          strlen(CTRL_MSG_CLOSE_WIFI_TEN_SEC));
        break;
    case CTRL_CODE_CLOSE_WIFI_THREE_SEC:
        ret = SendMessage(g_currentSessionId4Ctl, CTRL_MSG_CLOSE_WIFI_THREE_SEC,
                          strlen(CTRL_MSG_CLOSE_WIFI_THREE_SEC));
        break;
    case CTRL_CODE_CLOSE_WIFI_TEN_MIN:
        ret = SendMessage(g_currentSessionId4Ctl, CTRL_MSG_CLOSE_WIFI_TEN_MIN,
                          strlen(CTRL_MSG_CLOSE_WIFI_TEN_MIN));
        break;
    case CTRL_CODE_CLOSE_WIFI_FIVE_MIN:
        ret = SendMessage(g_currentSessionId4Ctl, CTRL_MSG_CLOSE_WIFI_FIVE_MIN,
                          strlen(CTRL_MSG_CLOSE_WIFI_FIVE_MIN));
        break;
    case CTRL_CODE_CHANGE_WIFI_TEN_SEC:
        ret = SendMessage(g_currentSessionId4Ctl, CTRL_MSG_CHANGE_WIFI_TEN_SEC,
                          strlen(CTRL_MSG_CHANGE_WIFI_TEN_SEC));
        break;
    case CTRL_CODE_CHANGE_WIFI_SIXTY_SEC:
        ret =
            SendMessage(g_currentSessionId4Ctl, CTRL_MSG_CHANGE_WIFI_SIXTY_SEC,
                        strlen(CTRL_MSG_CHANGE_WIFI_SIXTY_SEC));
        break;
    case CTRL_CODE_CHANGE_WIFI_LOOP20:
        ret = SendMessage(g_currentSessionId4Ctl, CTRL_MSG_CHANGE_WIFI_LOOP20,
                          strlen(CTRL_MSG_CHANGE_WIFI_LOOP20));
        break;
    case CTRL_CODE_CLOSE_WIFI_LOOP20:
        ret = SendMessage(g_currentSessionId4Ctl, CTRL_MSG_CLOSE_WIFI_LOOP20,
                          strlen(CTRL_MSG_CLOSE_WIFI_LOOP20));
        break;
    case CTRL_CODE_CHANGE_WIFI_LOOP100:
        ret = SendMessage(g_currentSessionId4Ctl, CTRL_MSG_CHANGE_WIFI_LOOP100,
                          strlen(CTRL_MSG_CHANGE_WIFI_LOOP100));
        break;
    case CTRL_CODE_CLOSE_WIFI_LOOP100:
        ret = SendMessage(g_currentSessionId4Ctl, CTRL_MSG_CLOSE_WIFI_LOOP100,
    ...
    case CTRL_CODE_OPEN_SESSION_FAIL:
        ...
        ret = SendMessage(g_currentSessionId4Ctl, CTRL_MSG_OPEN_SESSION_FAIL,
    ...
    case CTRL_CODE_OPEN_SESSION_NOT_EXIST:
        ret =
            SendMessage(g_currentSessionId4Ctl, CTRL_MSG_OPEN_SESSION_NOT_EXIST,
...
void SetTransStartTime(void) { g_transTimeStart = GetCurrentTimeOfMs(); }
...
// set/get function
void ResetClosedSessionCount4Data(void) { g_sessionCloseCount4Data = 0; }

void ResetClosedSessionCount4Ctrl(void) { g_sessionCloseCount4Ctrl = 0; }

int GetClosedSessionCount4Data(void) { return g_sessionCloseCount4Data; }

int GetClosedSessionCount4Ctrl(void) { return g_sessionCloseCount4Ctrl; }

void ResetOpenSessionCount4Data(void) { g_sessionOpenCount4Data = 0; }

void ResetOpenSessionCount4Ctrl(void) { g_sessionOpenCount4Ctrl = 0; }

int GetOpenSessionCount4Data(void) { return g_sessionOpenCount4Data; }

int GetOpenSessionCount4Ctrl(void) { return g_sessionOpenCount4Ctrl; }

int *GetSid4Task2(void) { return g_sId4Task2; }

int *GetSid4Task3(void) { return g_sId4Task3; }
...
pthread_barrier_t *GetThreadBarrier(void) { return g_barrier; }

char *GetNetworkId(void) { return g_networkId; }
...
IFileSendListener *GetSendFileListener(void) { return g_fileSendListener; }

IFileReceiveListener *GetRecvFileListener(void) { return g_fileRecvListener; }

SessionAttribute *GetSessionAttr4Data(void) { return g_sessionAttr4Data; }

SessionAttribute *GetSessionAttr4Ctl(void) { return g_sessionAttr4Ctl; }

SessionAttribute *GetSessionAttr4Pass(void) { return g_sessionAttr4Pass; }

SessionAttribute *GetSessionAttr4Perf(void) { return g_sessionAttr4Perf; }

SessionAttribute *GetSessionAttr4Proxy(void) { return g_sessionAttr4Proxy; }
...
int GetCurrentSessionId4Data(void) { return g_currentSessionId4Data; }

int GetCurrentSessionId4Ctl(void) { return g_currentSessionId4Ctl; }

int GetThreadResult4Data(void) { return g_threadResult4Data; }

int GetThreadResult4Ctl(void) { return g_threadResult4Ctl; }

ConnectionAddr *GetConnectAddr(void) { return &g_ethAddr; }
