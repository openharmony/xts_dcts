...
class XtsBuild:
    ...
    def parse_cmdline(self):
        ...
        if cmdline.get('system_size') == 'standard':
            build_target = cmdline['suite'] if cmdline.get('suite') else "test/xts/dcts:xts_dcts"
            ...
            build_target = cmdline['suite'] if cmdline.get('suite') else "dcts dcts_ivi dcts_intellitv dcts_wearable"
