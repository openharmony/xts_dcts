...
RetCode DcameraHdfDemo::SetMetadataMeter(uint8_t mode)
{
...
RetCode DcameraHdfDemo::SetMetadataAe(uint8_t mode)
{
    DHLOGI("demo test: SetMetadata enter");
    constexpr size_t entryCapacity = 100;
    constexpr size_t dataCapacity = 2000;
...
RetCode DcameraHdfDemo::SetMetadataFlash(uint8_t mode)
{
    DHLOGI("demo test: SetMetadata enter");
    constexpr size_t entryCapacity = 100;
    constexpr size_t dataCapacity = 2000;
...
RetCode DcameraHdfDemo::SetMetadataMirror(uint8_t mode)
{
    DHLOGI("demo test: SetMetadata enter");
    constexpr size_t entryCapacity = 100;
    constexpr size_t dataCapacity = 2000;
...
RetCode DcameraHdfDemo::SetMetadataJpeg(uint8_t mode)
{
    DHLOGI("demo test: SetMetadata enter");
    constexpr size_t entryCapacity = 100;
    constexpr size_t dataCapacity = 2000;
...
RetCode DcameraHdfDemo::SetMetadataAf(uint8_t mode)
{
    DHLOGI("demo test: SetMetadata enter");
    constexpr size_t entryCapacity = 100;
    constexpr size_t dataCapacity = 2000;
...
RetCode DcameraHdfDemo::SetMetadataFace(uint8_t mode)
{
    DHLOGI("demo test: SetMetadata enter");
    constexpr size_t entryCapacity = 100;
    constexpr size_t dataCapacity = 2000;
