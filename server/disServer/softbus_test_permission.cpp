...
//const static std::string SYSTEM_APP_PERMISSION = "com.huawei.permission.MANAGE_DISTRIBUTED_PERMISSION";
const static std::string SYSTEM_APP_PERMISSION = "com.permission.MANAGE_DISTRIBUTED_PERMISSION";
const static std::string DANGER_APP_PERMISSION = "ohos.permission.DISTRIBUTED_DATASYNC";
const static std::string BIND_DISCOVER_SERVICE = "com.huwwei.hwddmp.permission.BIND_DISCOVER_SERVICE";
...
void SoftBusPermission::AddPermission(const string &pkgName)
{
...
void SoftBusPermission::RemovePermission(const string &pkgName)
{
